...
namespace AuthenticationService.HostedService
{
    public class EventConsumerHostedService : BackgroundService
    {
        ...
        {
            _logger.LogInformation("AuthenticationService Event Consumer Hosted Service starting...");
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                {
                    _logger.LogInformation("AuthenticationService Event Consumer Hosted Service stopping...");
                    return;
                }
                catch (Exception ex)
                {
                    _logger.LogWarning(ex, "AuthenticationService Event Consumer Hosted Service could not start. Retrying in 5 seconds...");
