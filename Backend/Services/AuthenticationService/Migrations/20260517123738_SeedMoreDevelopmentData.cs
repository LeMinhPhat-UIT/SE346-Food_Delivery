    ...
    public partial class SeedMoreDevelopmentData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33333333-3333-4333-8333-333333333333"), new Guid("99999999-9999-4999-9999-999999999999") },
                    { new Guid("11111111-1111-4111-8111-111111111111"), new Guid("aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa") },
                    { new Guid("22222222-2222-4222-8222-222222222222"), new Guid("bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb") }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                ...
                keyValues: new object[] { new Guid("33333333-3333-4333-8333-333333333333"), new Guid("99999999-9999-4999-9999-999999999999") });

            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "RoleId", "UserId" },
                keyValues: new object[] { new Guid("11111111-1111-4111-8111-111111111111"), new Guid("aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa") });

            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "RoleId", "UserId" },
                keyValues: new object[] { new Guid("22222222-2222-4222-8222-222222222222"), new Guid("bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb") });
