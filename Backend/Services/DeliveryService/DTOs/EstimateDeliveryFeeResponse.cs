...
{
    public class EstimateDeliveryFeeResponse
    {
        ...
        public List<DeliveryFeePolicyBreakdownResponse> PolicyBreakdowns { get; set; } = new List<DeliveryFeePolicyBreakdownResponse>();
    }
}
