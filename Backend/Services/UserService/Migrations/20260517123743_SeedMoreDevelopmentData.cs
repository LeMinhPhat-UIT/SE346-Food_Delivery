    ...
    public partial class SeedMoreDevelopmentData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999999"), "https://example.com/avatars/shipper.png", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Seeded Shipper", null, null, 0, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("12121212-1212-1212-1212-121212121212"), "3 Nguyen Trai", "Ho Chi Minh City", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "District 1", true, "Home", 10.7691m, 106.6824m, "0900000003", "Seeded Shipper", null, new Guid("99999999-9999-9999-9999-999999999999"), "Pham Ngu Lao" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("34343434-3434-3434-3434-343434343434"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(1998, 4, 12, 0, 0, 0, 0, DateTimeKind.Utc), "Seeded Shipper", "https://example.com/shipper/id-back.jpg", "https://example.com/shipper/id-front.jpg", "079202600001", "https://example.com/shipper/license-back.jpg", "https://example.com/shipper/license-front.jpg", "DL-SEED-0001", "", new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "https://example.com/shipper/selfie.jpg", new Guid("99999999-9999-9999-9999-999999999999"), 1, new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc) });

            migrationBuilder.InsertData(
                table: "Shippers",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "RequestId", "Status", "UpdatedAt", "UserId", "VehiclePlate" },
                values: new object[] { new Guid("56565656-5656-5656-5656-565656565656"), new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc), null, new Guid("34343434-3434-3434-3434-343434343434"), 1, null, new Guid("99999999-9999-9999-9999-999999999999"), "59A-123.45" });
        }
