...
namespace UserService.Migrations
{
    ...
    [Migration("20260604104208_SeedAdditionalMerchants")]
    partial class SeedAdditionalMerchants
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UserService.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("d2d2d2d2-d2d2-4d2d-8d2d-d2d2d2d2d2d2"),
                            ...
                            UserId = new Guid("b2b2b2b2-b2b2-4b2b-8b2b-b2b2b2b2b2b2"),
                            Ward = "Ben Nghe"
                        },
                        new
                        {
                            Id = new Guid("d3d3d3d3-d3d3-4d3d-8d3d-d3d3d3d3d3d3"),
                            ...
                            UserId = new Guid("b3b3b3b3-b3b3-4b3b-8b3b-b3b3b3b3b3b3"),
                            Ward = "Vo Thi Sau"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("UserService.Entities.Merchant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("c2c2c2c2-c2c2-4c2c-8c2c-c2c2c2c2c2c2"),
                            AvgPrepTime = 18,
                        ...
                        new
                        {
                            Id = new Guid("c3c3c3c3-c3c3-4c3c-8c3c-c3c3c3c3c3c3"),
                            AvgPrepTime = 12,
                            ...
                            OpeningTime = new TimeSpan(0, 6, 30, 0, 0),
                            Status = "Approved",
            ...
            modelBuilder.Entity("UserService.Entities.MerchantAddress", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("e2e2e2e2-e2e2-4e2e-8e2e-e2e2e2e2e2e2"),
                            AddressLine = "15 Pasteur",
                            City = "Ho Chi Minh City",
                            CreatedAt = new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            District = "District 1",
                            Lat = 10.7781m,
                            Lng = 106.6993m,
                            MerchantId = new Guid("c2c2c2c2-c2c2-4c2c-8c2c-c2c2c2c2c2c2"),
                            Ward = "Ben Nghe"
                        },
                        new
                        {
                            Id = new Guid("e3e3e3e3-e3e3-4e3e-8e3e-e3e3e3e3e3e3"),
                            AddressLine = "42 Cach Mang Thang 8",
                            City = "Ho Chi Minh City",
                            CreatedAt = new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            District = "District 3",
                            Lat = 10.7815m,
                            Lng = 106.6843m,
                            MerchantId = new Guid("c3c3c3c3-c3c3-4c3c-8c3c-c3c3c3c3c3c3"),
                            Ward = "Vo Thi Sau"
                        });
                });
            ...
            modelBuilder.Entity("UserService.Entities.MerchantRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1a1a1a1-a1a1-4a1a-8a1a-a1a1a1a1a1a1"),
                            BusinessLicense = "BL-SEED-0001",
                            BusinessLicenseUrl = "merchant-requests/bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb/business-license.jpg",
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            RejectedReason = "",
                            ReviewedBy = new Guid("55555555-5555-4555-8555-555555555555"),
                            StoreDescription = "Default merchant store for local development.",
                            StoreName = "Seeded Merchant Store",
                            TaxId = "TAX-SEED-0001",
                            UserId = new Guid("bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb"),
                        ...
                        new
                        {
                            Id = new Guid("a2a2a2a2-a2a2-4a2a-8a2a-a2a2a2a2a2a2"),
                            BusinessLicense = "BL-SEED-0002",
                        ...
                        new
                        {
                            Id = new Guid("a3a3a3a3-a3a3-4a3a-8a3a-a3a3a3a3a3a3"),
                            BusinessLicense = "BL-SEED-0003",
            ...
            modelBuilder.Entity("UserService.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("b2b2b2b2-b2b2-4b2b-8b2b-b2b2b2b2b2b2"),
                        ...
                        new
                        {
                            Id = new Guid("b3b3b3b3-b3b3-4b3b-8b3b-b3b3b3b3b3b3"),
